...
namespace Microsoft.Build.UnitTests.FileTracking
{
    public sealed class FileTrackerTests : IDisposable
    {
        ...
        [TestMethod(Skip = "FileTracker tests require VS2015 Update 3 or a packaged version of Tracker.exe https://github.com/dotnet/msbuild/issues/649")]
...
class X
{
    static void Main()
    {
        ...
        [TestMethod(Skip = "Test fails in xunit because tracker includes the PID in the log file.")]
